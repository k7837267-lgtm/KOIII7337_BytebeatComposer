...
Q=(ca=c=>t*(0xCA98CA98>>(t>>c&30)&15),hpf((sin(ca(11)/128*PI)/3)+(sin(ca(11)/256*PI)*(1-t/4096%1))+(sin(ca(12)/128*PI)*(t/524288&1)),.5))*2,[dly(Q,rvrbHeads[0],.5,x=>bpf(x,.04,.2)),dly(Q,rvrbHeads[1],.6,x=>bpf(x,.048,.2))]