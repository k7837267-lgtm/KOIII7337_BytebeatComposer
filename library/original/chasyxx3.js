...
t||(
	rvrba=Array(rvrbn=4096).fill(0.5),
	lt9=t9=0,
	lw=w=0,
	bw=0
),
...
(t%307)||(
	...
	sides="|                                       |\n",
	t>=sc(cutoff16)&&(sides="║                                       ║\n"),	
	(t>1000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=top),
	(t>2000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>3000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>4000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>5000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>6000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>7000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>8000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=sides),
	(t>9000||dontMoveTheBoxABunchAsImTypingYouCodeBag)&&($+=bottom),
	$BOX=$,
	insert=(x,y,s,ns=0)=>{
		x|=0;y|=0;
		let cx = x;
	...
	(t<sc(16))&&(
		...
		(t>sc(3))&&insert(15,2,"Welcome to".slice(0, (t-sc(3))/500|0 )),
		(t>sc(5))&&insert(12,4,"THE UNICODE SHOW".slice(0, (t-sc(5))/500|0 )),
		(t>sc(7)&&t<sc(11))&&insert(12,6,"No two computers".slice( max(0,(t-sc(9))/500|0) , (t-sc(7))/500|0 )),
		(t>sc(7)&&t<sc(11))&&insert(9,7,"have the same symbols.".slice( max(0,(t-sc(9))/500|0) , (t-sc(7))/500|0 )),
		(t>sc(11)&&t<sc(15))&&insert(9,6,"I'll post a recording".slice( max(0,(t-sc(13))/500|0) , (t-sc(11))/500|0 )),
		(t>sc(11)&&t<sc(15))&&insert(15,7,"when I can.".slice( max(0,(t-sc(13))/500|0) , (t-sc(11))/500|0 )),
...
p1s=t>sc(171)?171:16,
p1=(t<sc(p1s!==16?1e10:36.55))&&pwm([-31,-31,-31,-31,-31,-31,-31,-31][t/s/2|0]||_,cos(t/s*PI/2))/2+
pwm([_,-19,-16,-18,_,-12,-16,-19][t/s/2|0]||_,-cos(t/s*PI/2))/2+((t>sc(cutoff16)&&t<sc(16.25))&&(random()-0.5)*(1-(t/4000%1)))+(t>sc(p1s)&&cbrt(sin(acc("fall",H(41-(max(0,t/s-p1s)*16)))))/4*sqrt(1-tanh((t/s-p1s)/3))+(random()-0.5)*(1-t/sc(0.125)%1)**2*sqrt(t/sc(0.5)%1)*2+pwm(-43,sin(t/s*PI/8)))/2+((t>sc(24)&&tri(-7,(t%sc(8))/s)+tri(-4,((t-sc(0.25))%sc(8))/s)+tri(0,((t-sc(0.5))%sc(8))/s)+tri(-11,((t-sc(3))%sc(8))/s)+tri(-7,((t-sc(3.25))%sc(8))/s)+tri(-2,((t-sc(3.5))%sc(8))/s))+(t>sc(28)&&tri(-12,((t-sc(4))%sc(8))/s)+tri(-7,((t-sc(4.25))%sc(8))/s)+tri(-4,((t-sc(4.25))%sc(8))/s)+tri(-14,((t-sc(6))%sc(8))/s)+tri(-7,((t-sc(6.25))%sc(8))/s)+tri(-5,((t-sc(6.5))%sc(8))/s)))/2,
p2=(t>sc(38)&&t<sc(43))&&(crzscf=x=>t&165&t%255&&t/256*(t&t>>x),crzsca=37649&1<<(t>>10&15)&&128*sin(2048/(t%1024)**.0125)+128,(((crzsca|crzscf(10)-crzscf(12)+128)^(t&8&t>>8||t>>4))&255)/256-0.5)+random()/2-0.25,
...
eas=((t>sc(83.5)&&t<sc(89.5))&&("UUUUUUUUUUUUUUUUUUUUU ALERT ALERT THIS IS VERY BAD OH NO THE GRIEF UUUUU".charCodeAt(t/s*64&127)>>(t/s*512&7)&1?sin(t/s*2000*PI*2):sin(t/s*3000*PI*2)))+((t>sc(90)&&t<sc(92))&&(sin(t/s*1200*PI*2)+sin(t/s*1800*PI*2)+sin(t/s*2700*PI*2))/3),
c7=(t>sc(94)&&t<sc(141.2)?1:0)*(rvrbc=((t*8)/(4+(t>>15)%16)*(1+(3&t>>13))>>(2&t>>11)&16)*8,
rvrb(rvrbc*1.00009**(-t%16384)%256/4,64,.8)*1.5/127-0.5+random()*0.2-0.1),
p1+((
		(t>sc(36.55)&&t<sc(38))||
		(t>sc(43)&&t<sc(44))||
		(t>sc(92)&&t<sc(94))
)&&(random()*2-1))+p2+p3+eas+c7+((t>sc(141.2)&&t<sc(151.1))&&((random()-0.5)*max(0.2,(t/s-144)/5)))+((t>sc(151.1)&&t<sc(170))&&bw*(((t/s-151.1)/10)**2)+bw)+(sin(t/8000*PI*2*3000)*((t>sc(165)&&t<sc(166))?1-cbrt(t-sc(165))%1:0))