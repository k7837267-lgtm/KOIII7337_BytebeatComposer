...
Q=(atan(sin(t/250*PI)*cos((t%[12288,16384,65536,1024][t>>14&1])/[12288,16384,65536,1024][t>>14&1]/2*PI)*50)/3*(t/131072&1)+lpf(atan(tan(t*2**(parseInt('FHKMOPRT'[t>>14&7],36)/12)/128*PI)),.1)/2),
[dly(Q,rvrbHeads[0],.4,x=>bpf(x,.05,.9)),dly(Q,rvrbHeads[1],.45,x=>bpf(x,.0457,.98))]