...
Q=(
  ...
  P=(spd,a)=>2**(parseInt(a[(t>>spd)%a.length],36)/12),
  J=t=>atan(tan(t)),
  sin(t/128*PI*(RP=P(15,'368B368B148A148A368B368B68BG68BI')))/2+cos(t/64*PI*RP)/3+lpr(J(t/128*PI*P(18,'3136')),(cos(t/262144*PI)**2)/2,.9)/9*(t>1048576)

),[dly(Q,rvrbHeads[0],.5,x=>bpf(x,.04,.2)),dly(Q,rvrbHeads[1],.6,x=>bpf(x,.048,.2))]